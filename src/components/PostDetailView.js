      ...
      <div className="flex-none md:flex-1 w-full max-w-md md:max-w-5xl m-auto">
        <div className="bg-white shadow-md px-8 pt-6 pb-6 mb-4">
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <div className="flex gap-6 justify-center md:justify-start">
              <button
                className="font-bold bg-lime-300 text-black uppercase text-sm border border-black shadow-offset-black hover:bg-lime-500 py-1 px-3 focus:outline-none focus:shadow-outline disabled:opacity-50 active:shadow-none"
                type="submit"
